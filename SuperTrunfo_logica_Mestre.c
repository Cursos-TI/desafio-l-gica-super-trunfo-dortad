//Desafio Logica Nivel Mestre  Aluno matricula 202502813139
...
int main() {
    ...
    printf("Escolha quais atributo voce quer usar para comparar as cartas: \n");
    ...
    printf("Digite o numero do primeiro atributo que voce quer comparar: \n");
    int opcao1;
    scanf("%d", &opcao1);
    printf("Digite o numero do segundo atributo que voce quer comparar: \n");
    int opcao2;
    scanf("%d", &opcao2);
    ...
    if (opcao1 == opcao2 ) {
        printf("voce escolheu o mesmo atributo para comparar as cartas\n");
        printf("voce deve escolher dois atributos diferentes para comparar as cartas\n");
    }else
    {     
        printf("/n");
